...
pub fn refract_ray(inter: &Intersection, dir: Vec3, ior: f64) -> Option<Ray> {
...
impl Intersection {
    ...
    pub fn new(ray: Ray, t: f64, normal: Vec3, material: Material) -> Intersection {
        Intersection {
            t: t,
